...
def make_boot_install(script,boot_img,input_zip,output_zip):
    ...
    shutil.copy( os.path.join(android_root,
                   "device","htc","dream_sapphire","kernel","ebi0-zImage"),
    ...
    shutil.copy( os.path.join(android_root,
                   "device","htc","dream_sapphire","kernel","ebi1-zImage"),
    ...
    fp=open(os.path.join(android_root,
              "device","htc","dream_sapphire","kernel","ebi0-modules.sqf"),
              "rb")
    common.ZipWriteStr(output_zip,"kernel/ebi0-modules.sqf",fp.read())
    fp.close()

    fp=open(os.path.join(android_root,
              "device","htc","dream_sapphire","kernel","ebi1-modules.sqf"),
              "rb")
    ...
    fp=open(os.path.join(android_root,
              "out","target","product","dream_sapphire","obj","EXECUTABLES",
